...
function Description(props) {
  return (
    <article className="shadow-sm bg-white flex max-w-[480px] w-full flex-col mx-auto pt-4 pb-12 rounded-2xl items-end">
      <img
        loading="lazy"
        ...
        alt="Task Logo"
      />
      <div className="self-stretch flex w-full flex-col mt-14 mb-60 pl-8 pr-4">
        ...
        <section className="text-black text-lg self-stretch mt-4">
          I need to call Rohan and ask if he has completed his Data Structure assignment.
          <br />
          <br />
